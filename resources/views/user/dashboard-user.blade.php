                ...
                <div id="mdl-footer" class="rounded-b border-t border-gray-200 p-4 dark:border-gray-600 md:p-5">
                    <form id="kirim-disposisi" method="POST">
                        <div class="flex items-start justify-between gap-2">
                            @csrf
                            <input required placeholder="Masukkan keterangan disposisi" type="text" name="konten"
                                id="konten" autocomplete="konten"
                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm sm:leading-6">

                            <select id="tujuan" required
                                class="block w-1/2 rounded-lg border border-gray-300 bg-gray-50 p-2 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500">
                                <option selected value="0">Pilih Tujuan</option>
                                <option value="2">Wakil Dekan 1</option>
                                <option value="3">Wakil Dekan 2</option>
                                <option value="4">Wakil Dekan 3</option>
                            </select>
                        </div>
...
<script type="module">
    ...
    $(document).ready(function() {
        $('#kirim-disposisi').on('submit', function(e) {
            ...
            if (selectedDispo.status_disposisi) {
