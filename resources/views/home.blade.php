    ...
    <form>
        <div class="space-y-12 max-w-3xl mx-auto p-6 bg-white rounded-lg">
            <div class="border-b border-gray-900/10 pb-12">
                <h2 class="text-base font-semibold leading-7 text-gray-900">Please fill out required field</h2>
                <p class="mt-1 text-sm leading-6 text-gray-600">(<span class="text-red-500">*</span> is required)</p>
